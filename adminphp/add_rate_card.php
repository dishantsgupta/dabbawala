...
if(isset($_POST['add'])){
    ...
    $sql2 = "insert into rate_card(card_name,package_name,package_price,isActive) values('$cardTitle','$packageName','$packagePrice','1')";
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="padding: 12px 10px;display: inline-block;justify-content: center;"><a style="padding: 0px;width: 0px;" href="rate_update.php?id=<?php echo $result['id']; ?>"><i style="padding: 3px 7px; background: green;font-size: 23px;color:#fff;" class="uil uil-edit-alt"></i></a></td>

                                    <td style="padding: 12px 10px;display: inline-block;justify-content: center;"><a onclick="return confirm('Are you really want to delete this area.......')" style="padding: 0px; width: 0px;" href="rate_delete.php?id=<?php echo $result['id']; ?>"><i style="padding: 3px 7px; background: red;font-size: 23px;color:#fff;" class="uil uil-trash-alt"></i></a></td>
