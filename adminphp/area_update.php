...
$sqlQuery = "select * from area where id = '$area_id'";
        ...
        <section class="main">
            ...
            <div class="users">
                ...
                <div style="background: #f3f3f3;" class="card">
                    ...
                    <form action="area_updata_data.php?id=<?php echo $result['id']; ?>" method="POST">
                        <input name="district" type="text" value="<?php echo $result['area']; ?>" placeholder="Enter here district / city name">
