...
$sql1 = "select * from district where isActive = 1";
$query1 = mysqli_query($connect, $sql1);

if (isset($_POST['add'])) {
    $districtName = $_POST['district'];
    $sql3 = "insert into district(district,isActive) values('$districtName','1')";
    ...
    <div class="container">
        <nav id="navclick">
            <ul>
                ...
                <li><a class="icon active" href="add_fields.php"><i style="font-size: 25px;" class="fas uil uil-create-dashboard"></i>
            ...
            <div class="users">
                ...
                <div style="background: #f3f3f3;" class="card">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                        <input type="text" name="district" placeholder="Enter here district / city name">
                    ...
                    <table class="table" id="table">
                        ...
                        <tbody>
                            ...
                            while ($result1 = mysqli_fetch_assoc($query1)) {
                                ...
                                $sql2 = "select district_id from area where district_id = {$result1['id']}";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $result1['district']; ?></td>


                                    <td style="padding: 12px 10px;display: inline-block;justify-content: center;"><a style="padding: 0px;width: 0px;" href="district_update.php?id=<?php echo $result1['id']; ?>"><i style="padding: 3px 7px; background: green;font-size: 23px;color:#fff;" class="uil uil-edit-alt"></i></a></td>

                                    <td style="padding: 12px 10px;display: inline-block;justify-content: center;"><a onclick="return confirm('Are you really want to delete this district / city.......')" style="padding: 0px; width: 0px;" href="district_delete.php?id=<?php echo $result1['id']; ?>"><i style="padding: 3px 7px; background: red;font-size: 23px;color:#fff;" class="uil uil-trash-alt"></i></a></td>
