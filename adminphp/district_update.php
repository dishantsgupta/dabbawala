...
$sqlQuery = "select * from district where id = $dis_id";
$mysqlQuery = mysqli_query($connect,$sqlQuery);
        ...
        <section class="main">
            ...
            <div class="users">
                ...
                <div style="background: #f3f3f3;" class="card">
                    ...
                    <h4>Update District / City</h4>

                    <form action="district_data_update.php?id=<?php echo $result['id']; ?>" method="POST">
                        <input name="district" type="text" value="<?php echo $result['district']; ?>" placeholder="Enter here district / city name">
